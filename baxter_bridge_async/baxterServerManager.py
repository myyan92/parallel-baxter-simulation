...
waitstart = None
while True:
    if os.path.isfile('/home/baxter_bridge_async/sockets.txt'):
        with open('/home/baxter_bridge_async/sockets.txt', 'r') as f:
            lines = f.readlines()
        for l in lines:
            try:
...
with open('/home/baxter_bridge_async/sockets.txt', "w") as f:
    pass
